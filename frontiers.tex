...
%
We assume that there is an external mechanism that acting on the hippocampus and which is responsible for synchronising the activity through the CA3 dynamics and the entire network. There could be a clock like gamma oscillation, which has been observed in the hippocampus (6). Therefore, neuronal oscillations allow for temporal segmentation of neuronal spikes. 
%
Hiere, we assume that the storage and retrieval of the input patterns can happen in gamma time scale.
%
These gamma oscillations synchronizing spikes and creates pause between items in a message to prevent errors in decoding. 
%
...
%
In order to get something in order of the behavioural time scale which is stored in gamma cycle, we postulate that the inputs to the hippocampus are temporaly compressed due to the phase precession (O'Keefe and Recce, 1993) out of the hippocampus e. g., phase precession hase been observed in the EC (?). 
%
