...
%According to the results, the amount of pattern completion by EC-CA3 is the same for all CA3 models (first row).
...
%This is apparent in the first column of Fig.~\ref{Fig_5} as well.
...
%Since the random inputs are orthogonal, the EC-CA3 projection shows roughly the same amount of pattern completion for different CA3 models (see Fig.~\ref{Fig_6}, first row).
