...
%
Despite the importance of the CA3 area in memory function, its underlying synaptic mechanisms are poorly understood. Guzman et al. found sparse connections (around $\%$1) but non-random and highly enriched in disynaptic connectivity motifs between CA3 neurons,(\cite guzman), which is proposed to serve as efficient memory storage and retrieval in this brain region \cite{guzman2016synaptic}. 
